...
// @grant        unsafeWindow
// @updateURL    https://raw.githubusercontent.com/mateusobozovski/MogScripts/refs/heads/main/Mog.user.js
// @downloadURL  https://raw.githubusercontent.com/mateusobozovski/MogScripts/refs/heads/main/Mog.user.js
// @run-at       document-end
// ==/UserScript==
...
(() => {
  ...
  GM_addStyle(`
    ...
    .mog-launcher:hover { width: 46px; background: ${COLOR_ACCENT}; }
  ...
  panel.innerHTML = `
    ...
    <aside class="mog-side">
      ...
      <div class="mog-side-item mog-side-root" data-section="defenses">
        <span class="mog-side-icon">🛡</span>
